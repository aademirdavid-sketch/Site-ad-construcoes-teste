...
# 3. Cabeçalho Centralizado com Logo 80% Maior
...
with col_logo:
    ...
    if os.path.exists(path_imagem):
        ...
        st.image("https://cdn-icons-png.flaticon.com/512/4333/4333644.png", width=400)
...
performance para o gerenciamento de Obras,industriais e infraestrutura urbana. 
Nossa metodologia é fundamentada no estrito cumprimento das Normas Tecnicas, 
...
st.markdown('<h3 class="section-title">Contato</h3>', unsafe_allow_html=True)
...
with col_c2:
    ...
    st.write("")
    st.link_button("SOLICITAR CONTATO VIA WHATSAPP", "https://wa.me/5513991728590", type="primary", use_container_width=True)
...
st.markdown("""
    <div style="text-align: center; color: #94a3b8; font-size: 12px; padding-bottom: 30px;">
        ...
        Foco em SOLUÇÕES TTÉCNICAS PARA CONSTRUÇÃO CIVIL.
    </div>
    """, unsafe_allow_html=True)
